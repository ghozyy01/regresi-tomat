...
st.sidebar.success("Dibuat dengan ❤ oleh Ghozy Gantenk")
...
st.markdown(
    "Aplikasi machine learning regression untuk menghitung total penjualan tomat "
    "berdasarkan fitur Harga, Hari, Cuaca, dan Promo"
)
